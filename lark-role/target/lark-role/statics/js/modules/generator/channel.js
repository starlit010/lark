$(function () {
    $("#jqGrid").jqGrid({
        ...
        colModel: [			
			...
			{ label: '', name: 'companyid', index: 'companyId', width: 80 }, 			
			{ label: '', name: 'channelCode', index: 'channel_code', width: 80 }, 			
...
var vm = new Vue({
	...
	methods: {
		...
		saveOrUpdate: function (event) {
			var url = vm.channel.channelId == null ? "channel/save" : "channel/update";
			$.ajax({
				type: "POST",
			    url: baseURL + url,
		...
		getInfo: function(channelId){
			$.get(baseURL + "channel/info/"+channelId, function(r){
