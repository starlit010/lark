...
var vm = new Vue({
	...
	methods: {
		...
		saveOrUpdate: function (event) {
			var url = vm.sysRoleDept.id == null ? "sysroledept/save" : "sysroledept/update";
			$.ajax({
				type: "POST",
			    url: baseURL + url,
		...
		del: function (event) {
			...
			confirm('确定要删除选中的记录？', function(){
				$.ajax({
					type: "POST",
				    url: baseURL + "sysroledept/delete",
				    contentType: "application/json",
		...
		getInfo: function(id){
			$.get(baseURL + "sysroledept/info/"+id, function(r){
